...
let mainQuestions = [
    {
        text: 'Коэффициент, который позволяет определить пропорцию, составляющую введенные основные активы в общую стоимость на окончание расчетного периода времени – это:',
        right: [0,],
        type: 1,
        points: 100,
