...
// dran&drop 2
const anwserArr2 = ['Линии электропередач','Газопровод','Сооружения','Машины','Оборудование','Здания','Транспорт','Инструмент','Жилой дом','Сооружения бытовые','Столовая','База отдыха']; //Ответы
const countCol = 2; //Колличесвто колонн
// Правильные ответы для каждой колонки
const correctAnswers = [
    ['Линии электропередач','Газопровод','Сооружения','Машины','Оборудование','Здания','Транспорт','Инструмент'],  // Правильные ответы для первой колонки
    ['Жилой дом','Сооружения бытовые','Столовая','База отдыха']   // Правильные ответы для второй колонки
];




let questionNumBlc = document.querySelector('#num_question_1')
...
questionNumBlc.innerHTML = numberOfQuestion + '. '
