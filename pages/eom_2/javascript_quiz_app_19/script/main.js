...
let mainQuestions = [
    {
        text: 'Коэффициент не имеет установленного нормативного значения, но он помогает определить процессы, происходящие на предприятии в связи с развитием его производственной базы и основных средств, которые не связаны с производственным процессом:',
        right: [3,],
        type: 1,
        points: 100,
        answers: ['коэффициент обновления основных фондов','коэффициент выбытия основных фондов','скорость обновления основных средств','коэффициент прироста основных средств',],
    },
];
