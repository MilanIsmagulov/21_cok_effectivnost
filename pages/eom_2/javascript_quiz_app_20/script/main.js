...
let mainQuestions = [
    {
        text: 'Коэффициент, который помогает оценить состояние основных фондов предприятия. Он позволяет определить, насколько изношены и устарели активы на определенную дату. Чем он выше, тем лучше физическое состояние основных фондов:',
        right: [1,],
        type: 1,
        points: 100,
        answers: ['коэффициент обновления основных фондов','коэффициент годности основных фондов','коэффициент прироста основных средств','коэффициент выбытия основных фондов',],
    },
];
